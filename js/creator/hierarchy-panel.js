...
const HierarchyPanel = (() => {
    ...
    function init(containerSelector) {
        ...
        container.innerHTML = `
            <div class="hierarchy-header">
                ...
                <input type="text" class="hierarchy-search" placeholder="Search..." />
            </div>
    ...
    function _buildTree() {
        ...
        if (typeof World !== 'undefined' && World.blockMap) {
            World.blockMap.forEach((block, key) => {
                ...
                _blockIdToNodeId.set(key, blockNode.id);
            });
        }
    ...
    function _filterTree(query) {
        document.querySelectorAll('.hierarchy-node').forEach(nodeEl => {
            const name = nodeEl.querySelector('.node-name').textContent.toLowerCase();
